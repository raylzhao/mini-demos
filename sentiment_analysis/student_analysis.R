...
student_sentiment <- data.frame(get_sentiment(student_sentences, method = "syuzhet"))
student_analysis <- cbind(sentence = student_sentences, sentiment = student_sentiment)
